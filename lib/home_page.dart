...
//   Future<void> refreshFavouriteRecipes() async {
//     setState(() {
//       _favouriteRecipesFuture = getRecipeFromDb();
//     });
//   }
...
//       onRefresh: refreshFavouriteRecipes,
//       child: Scaffold(
//         appBar: AppBar(
//           toolbarHeight: 60,
//           title: const Row(
...
//     var recipeDb = await RecipeDatabaseHelper().getRecipes();
//     return recipeDb;
//   }
// }
...
class _MyHomePageState extends State<MyHomePage> {
  Future<List<Map<String, dynamic>>>? _favouriteRecipesFuture;
  String? _username; // Variable to hold the logged-in username

  @override
  void initState() {
    super.initState();
    _favouriteRecipesFuture = getRecipeFromDb();
    _fetchUsername(); // Fetch the username during initialization
  }
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Scaffold(
        ...
        drawer: UserMenu(username: _username ?? 'Guest'), // Pass username
        body: SafeArea(
          child: SingleChildScrollView(
            child: Padding(
              padding: const EdgeInsets.all(20.0),
